				...
				<div class="header__item header__item_notification js-header-item">
					...
					<div class="header__body js-header-body">
						...
						<div class="header__list">
							<a class="header__notification" href="activity">
								<div class="header__preview">
									<img
										src={'img/content/notification-pic-1.jpg'}
										alt="Notification"
									/>
								</div>
							...
							<a class="header__notification" href="activity">
								<div class="header__preview">
									<img
										src={'img/content/notification-pic-2.jpg'}
										alt="Notification"
									/>
								</div>
								<div class="header__details">
							...
							<a class="header__notification" href="activity">
								<div class="header__preview">
									<img
										src={'img/content/notification-pic-3.jpg'}
										alt="Notification"
									/>
								</div>
								<div class="header__details">
							...
							<a class="header__notification" href="activity">
								<div class="header__preview">
									<img
										src={'img/content/notification-pic-4.jpg'}
										alt="Notification"
									/>
								</div>
								<div class="header__details">
							...
							<a class="button-small header__button" href="activity">
								See all
							</a>
						</div>
					</div>
				...
				<div class="header__item header__item_user js-header-item js-demo-user">
					<button class="header__head js-header-head">
						<div class="header__avatar">
							<img src={'img/content/avatar-user.jpg'} alt="Avatar" />
						</div>
						<div class="header__wallet">
							7.00698 <span class="header__currency">ETH</span>
						</div>
					</button>
					<div class="header__body js-header-body">
						...
						<div class="header__wrap">
							<div class="header__line">
								<div class="header__img">
									<img src={'img/content/etherium-circle.jpg'} alt="Etherium" />
								</div>
								<div class="header__details">
						...
						<div class="header__menu">
							...
							<a class="header__link" href="item">
								<div class="header__icon">
						...
						<div class="variants__center center">
							<div class="variants__top">
								...
								<div class="variants__info">
									...
									be one of a kind or <span>“Multiple”</span> if you want to
							...
							<div class="variants__list">
								<div class="variants__item">
									<div class="variants__preview">
										<img
											srcSet={'img/content/upload-pic-1@2x.jpg 2x'}
											src={'img/content/upload-pic-1.jpg'}
											alt="Upload"
										/>
									</div>
									<a
								...
								<div class="variants__item">
									<div class="variants__preview">
										<img
											srcSet={'img/content/upload-pic-2@2x.jpg 2x'}
											src={'img/content/upload-pic-2.jpg'}
											alt="Upload"
										/>
									</div>
									<a
										class="button-stroke variants__button"
										href="upload-details-multiple"
									>
										Create Multiple
									</a>
								</div>
							</div>
							<div class="variants__note">
