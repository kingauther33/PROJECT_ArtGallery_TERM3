				...
				<div className="outer__inner">
					...
					<div className="popup popup_wallet mfp-hide" id="popup-wallet">
						...
						<div className="steps">
							<div className="steps__item">
								<div className="steps__head">
									...
									<div className="steps__details">
										<div className="steps__info">Upload files & Mint token</div>
										<div className="steps__text">Call contract method</div>
									</div>
								</div>
							...
							<div className="steps__item">
								<div className="steps__head">
									...
									<div className="steps__details">
										<div className="steps__info">Sign sell order</div>
							...
							<div className="steps__item">
								<div className="steps__head">
									...
									<div className="steps__details">
										<div className="steps__info">Sign lock order</div>
										<div className="steps__text">
											Sign sell order using your wallet
										</div>
									</div>
						...
						<div className="steps__note">
							...
							<a className="js-popup-close" href="/">
								try again
							</a>
						</div>
					</div>
