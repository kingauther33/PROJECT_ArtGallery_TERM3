...
const Item = () => {
	...
	const [highestBidLog, setHighestBigLog] = useState(null);
	const { id: artworkId } = useParams();

	const fetchArtworkById = useCallback(async () => {
		await axios
			.get(API.getArtworkById.url + artworkId, HeaderOptions)
			.then((res) => {
				setArtwork(res.data);
			})
	...
	const fetchHighestBidLog = useCallback(async () => {
		await axios
			.get(API.getHighestBidLog.url + artworkId, HeaderOptions)
			.then((res) => {
				setHighestBigLog(res.data);
			})
			.catch((error) => console.error(error));
	}, [artworkId]);
	...
	useEffect(() => {
		fetchArtworkById();
		fetchHighestBidLog();
	}, [fetchArtworkById, fetchHighestBidLog]);
	...
	return (
		<>
			{showPopup && (
				<>
					<div
						className="mfp-bg mfp-zoom-in mfp-ready"
						onClick={closePopUp}
					></div>
					<div
					...
					>
						<div className="mfp-container mfp-s-ready mfp-inline-holder">
							<div className="mfp-content">
								<div className="popup popup_bid" id="popup-bid">
			...
			<div className="outer">
				<div className="outer__inner">
					<div className="section item">
						<div className="item__center center">
							<div className="item__bg">
								<div className="item__preview">
									<div className="item__categories">
										<div className="status-black item__category">
											{artwork?.category?.name}
										</div>
									</div>
									<img srcSet={artwork?.images} alt={artwork?.name} />
								</div>
								{/* <div className="options">
									<div className="options__list">
										...
										<div className="actions js-actions">
											...
											<div className="actions__body js-actions-body">
												<a
													className="actions__item js-popup-open"
													href="#popup-price"
													data-effect="mfp-zoom-in"
												>
									...
									<div className="options__box js-options-box">
										<div className="options__stage">
											Share link to this page
										</div>
										<div
											className="options__share share-btn"
											data-url="https://ui8.net"
										>
											<a
												className="options__direction btn-twitter"
												href="/"
												data-id="tw"
											>
												<span>
											...
											<a
												className="options__direction btn-facebook"
												href="/"
												data-id="fb"
											>
												<span>
							...
							<div className="item__details">
								<h1 className="item__title h3">{artwork?.name}</h1>
								{highestBidLog !== null ? (
									<div className="item__cost">
										<div className="status-stroke-green item__price">
											NOW: {highestBidLog?.moneyBid} $
										</div>

										<div className="status-stroke-black item__price">
											FIXED: ${artwork?.aunction?.fixedPrice}
										</div>
									</div>
								) : (
									<></>
								)}
								<div className="item__text mb-2">{artwork?.description}</div>
								<div className="item__text row">
									<div className="col-12 mb-2">Year: {artwork?.year}</div>
									<div className="col-12 mb-2">Author: {artwork?.author}</div>
								...
								{/* <div className="item__tabs js-tabs">
									<div className="item__nav">
										<a className="item__link js-tabs-link active" href="/">
											Info
										</a>
										<a className="item__link js-tabs-link" href="/">
											Owners
										</a>
										<a className="item__link js-tabs-link" href="/">
											History
									...
									<div className="item__container">
										<div
											className="item__box js-tabs-item"
											style={{ display: 'block' }}
										>
											<div className="item__users">
												<div className="item__user">
													<div className="item__avatar">
														...
														<div className="item__reward">
															<img src={images.Homepage.owner} alt="Reward" />
														</div>
													</div>
												...
												<div className="item__user">
													...
													<div className="item__description">
														...
														<div className="item__action">
															Place a bid:{' '}
															<span className="item__money">1.46 ETH</span>
														</div>
													</div>
										...
										<div className="item__box js-tabs-item">
											<div className="item__users">
												<div className="item__user">
													...
													<div className="item__description">
														<div className="item__action">
															Highest bid: <span>1.46 ETH</span>
														</div>
														<div className="item__name">Raquel Will</div>
													</div>
												</div>
								...
								{highestBidLog !== null ? (
									<div className="item__control">
										<div className="item__head">
											...
											<div className="item__description">
												<div className="item__info">
													Highest bid by{' '}
													<span>
														{`${highestBidLog?.buyer?.lastName} ${highestBidLog?.buyer?.firstName}`}
													</span>
												</div>
												<div className="item__currency">
													<div className="item__price">
														<span>{highestBidLog?.moneyBid}</span> $
													</div>
												</div>
											</div>
										</div>
										<div className="item__btns">
											{/* <Link
											className="button item__button js-popup-open"
											to="#"
											data-effect="mfp-zoom-in"
										...
										>
											...
											<Link
												className="button-stroke item__button js-popup-open"
												to="#"
												data-effect="mfp-zoom-in"
												onClick={showPopUp}
											>
										...
										<div className="item__variants">
											Service fee <span className="item__percent">1.5%</span>{' '}
					...
					<div className="popup popup_purchase mfp-hide" id="popup-purchase">
						...
						<div className="popup__item">
							<div className="success">
								<div className="success__title h2">
									Yay!{' '}
						...
						<div className="accept">
							<div className="accept__line">
								...
								<div className="accept__text">
									You are about to accept a bid for <strong>C O I N Z</strong>{' '}
									from <strong>UI8</strong>
								</div>
							</div>
					...
					<div className="popup popup_price mfp-hide" id="popup-price">
						...
						<div className="popup__btns">
							<button className="button-purple popup__button js-popup-close">
								Change price
							</button>
							<button className="button-stroke popup__button js-popup-close">
								Cancel
					...
					<div className="popup popup_transfer mfp-hide" id="popup-transfer">
						...
						<div className="popup__btns">
							<button className="button popup__button js-popup-close">
								Continue
							</button>
							<button className="button-stroke popup__button js-popup-close">
								Cancel
