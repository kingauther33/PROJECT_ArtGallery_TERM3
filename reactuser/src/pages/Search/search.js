				...
				<div class="outer__inner">
							...
							<div class="catalog__row">
								...
								<div class="catalog__wrapper">
									<div class="catalog__list">
										<div class="card">
											<div class="card__preview">
												...
												<div class="card__control">
													<div class="status-green card__category">
														purchasing !
													</div>
										...
										<div class="card">
											<div class="card__preview">
												<img srcSet={images.Homepage.img3} alt="Card preview" />
												<div class="card__control">
													<div class="status-green card__category">
														purchasing !
													</div>
										...
										<div class="card">
											<div class="card__preview">
												<img srcSet={images.Homepage.img4} alt="Card preview" />
												<div class="card__control">
													<div class="status-green card__category">
														purchasing !
													</div>
										...
										<div class="card">
											<div class="card__preview">
												<img srcSet={images.Homepage.img5} alt="Card preview" />
												<div class="card__control">
													<div class="status-green card__category">
														purchasing !
													</div>
										...
										<div class="card">
											<div class="card__preview">
												<img srcSet={images.Homepage.img6} alt="Card preview" />
												<div class="card__control">
													<div class="status-green card__category">
														purchasing !
													</div>
										...
										<div class="card">
											<div class="card__preview">
												<img srcSet={images.Homepage.img7} alt="Card preview" />
												<div class="card__control">
													<div class="status-green card__category">
														purchasing !
													</div>
										...
										<div class="card">
											<div class="card__preview">
												<img srcSet={images.Homepage.img2} alt="Card preview" />
												<div class="card__control">
													<div class="status-green card__category">
														purchasing !
													</div>
					...
					<div class="popup popup_bid mfp-hide" id="popup-bid">
						...
						<div class="popup__btns">
							<a
								class="button popup__button js-popup-open"
								href="#popup-wallet"
								data-effect="mfp-zoom-in"
							>
								Place a bid
							</a>
							<button class="button-stroke popup__button js-popup-close">
								Cancel
							</button>
						</div>
					</div>
