          ...
          <div class="control__center center"><a class="button-stroke button-small control__button" href="index.html">
            ...
            <div class="breadcrumbs">
              <ul class="breadcrumbs">
                <li class="breadcrumbs__item"><a class="breadcrumbs__link" href="profile.html">Profile</a></li>
                <li class="breadcrumbs__item">Activity</li>
              </ul>
            </div>
          </div>
        </div>
        <div class="section-pt80 activity">
          <div class="activity__center center">
            <div class="activity__top">
              <h1 class="activity__title h2">Activity</h1>
            ...
            <div class="activity__row">
              ...
              <button class="button-stroke button-small mobile-show activity__button">Mark all as read</button>
              <div class="activity__filters js-activity-filters">
                <div class="activity__info">Filters</div>
                <div class="activity__group">
                  <label class="checkbox">
                    <input class="checkbox__input" type="checkbox" checked="checked"/><span class="checkbox__inner"><span class="checkbox__tick"></span><span class="checkbox__text">Sales</span></span>
                  </label>
                  <label class="checkbox">
                    <input class="checkbox__input" type="checkbox"/><span class="checkbox__inner"><span class="checkbox__tick"></span><span class="checkbox__text">Listings</span></span>
                  </label>
                  <label class="checkbox">
                    <input class="checkbox__input" type="checkbox"/><span class="checkbox__inner"><span class="checkbox__tick"></span><span class="checkbox__text">Bids</span></span>
                  </label>
                  <label class="checkbox">
                    <input class="checkbox__input" type="checkbox" checked="checked"/><span class="checkbox__inner"><span class="checkbox__tick"></span><span class="checkbox__text">Burns</span></span>
                  </label>
                  <label class="checkbox">
                    <input class="checkbox__input" type="checkbox"/><span class="checkbox__inner"><span class="checkbox__tick"></span><span class="checkbox__text">Followings</span></span>
                  </label>
                  <label class="checkbox">
                    <input class="checkbox__input" type="checkbox" checked="checked"/><span class="checkbox__inner"><span class="checkbox__tick"></span><span class="checkbox__text">Likes</span></span>
                  </label>
                  <label class="checkbox">
                    <input class="checkbox__input" type="checkbox"/><span class="checkbox__inner"><span class="checkbox__tick"></span><span class="checkbox__text">Purchase</span></span>
                  </label>
                  <label class="checkbox">
                    <input class="checkbox__input" type="checkbox" checked="checked"/><span class="checkbox__inner"><span class="checkbox__tick"></span><span class="checkbox__text">Transfers</span></span>
                  </label>
                </div>
                <div class="activity__btns">
                  <button class="button-stroke button-small activity__button js-activity-select">Select all</button>
                  <button class="button-stroke button-small activity__button js-activity-unselect">Unselect all</button>
                </div>
              </div>
            </div>
          </div>
