						...
						<div className="profile__head js-profile-head profile__bg">
							<div className="profile__center center">
								...
								<div className="profile__btns">
									<button className="button-stroke button-small profile__button js-profile-load">
							...
							<div className="profile__center center">
								<div className="user">
									...
									<div className="user__control">
										<div className="user__btns">
											<button className="button-stroke button-small user__button js-user-follow active">
												<span>Unfollow</span>
												<span>Follow</span>
											</button>
											...
											<a
												className="button-circle-stroke button-small user__button js-popup-open"
												href="#popup-report"
										...
										<div className="user__box js-user-box">
											...
											<div
												className="user__share share-btn"
												data-url="https://ui8.net"
											>
												<a
													className="user__direction btn-twitter"
													href="/"
													data-id="tw"
												>
													<span>
												...
												<a
													className="user__direction btn-facebook"
													href="/"
													data-id="fb"
												>
													<span>
								...
								<div className="profile__wrapper js-tabs">
									...
									<div className="profile__container">
										<div
											className="profile__item js-tabs-item"
											style={{ display: 'block' }}
										>
										...
										<div className="profile__item js-tabs-item">
											<div className="profile__list">
												<div className="card">
													<div className="card__preview">
														<img
															srcSet="img/content/card-pic-1@2x.jpg 2x"
															src="img/content/card-pic-1.jpg"
															alt="Card preview"
														/>
														<div className="card__control">
															<div className="status-green card__category">
												...
												<div className="card">
													<div className="card__preview">
														<img
															srcSet="img/content/card-pic-2@2x.jpg 2x"
															src="img/content/card-pic-2.jpg"
															alt="Card preview"
														/>
														<div className="card__control">
															<div className="status-green card__category">
										...
										<div className="profile__item js-tabs-item">
											<div className="profile__list">
												...
												<div className="card">
													<div className="card__preview">
														<img
															srcSet="img/content/card-pic-3@2x.jpg 2x"
															src="img/content/card-pic-3.jpg"
															alt="Card preview"
														/>
														<div className="card__control">
															<div className="status-green card__category">
												...
												<div className="card">
													<div className="card__preview">
														<img
															srcSet="img/content/card-pic-4@2x.jpg 2x"
															src="img/content/card-pic-4.jpg"
															alt="Card preview"
														/>
														<div className="card__control">
															<div className="status-green card__category">
										...
										<div className="profile__item js-tabs-item">
											<div className="profile__list">
												...
												<div className="card">
													<div className="card__preview">
														<img
															srcSet="img/content/card-pic-5@2x.jpg 2x"
															src="img/content/card-pic-5.jpg"
															alt="Card preview"
														/>
														<div className="card__control">
															<div className="status-green card__category">
													...
													<div className="followers__item">
														<div className="followers__user">
															<div className="followers__avatar">
																<img
																	src={'img/content/avatar-5.jpg'}
																	alt="Avatar"
																/>
															</div>
															<div className="followers__details">
																<div className="followers__name">
																	Sally Fadel
																</div>
																<div className="followers__counter">
																	161 followers
																</div>
																<button className="button-stroke button-small followers__button">
																	Unfollow
																</button>
															</div>
														</div>
														<div className="followers__wrap">
															<div className="followers__gallery">
																<div className="followers__preview">
																	<img
																		src={'img/content/follower-pic-1.jpg'}
																		alt="Follower"
																	/>
																</div>
																<div className="followers__preview">
																	<img
																		src={'img/content/follower-pic-2.jpg'}
																		alt="Follower"
																	/>
																</div>
																<div className="followers__preview">
																	<img
																		src={'img/content/follower-pic-3.jpg'}
																		alt="Follower"
																	/>
																</div>
																<div className="followers__preview">
																	<img
																		src={'img/content/follower-pic-4.jpg'}
																		alt="Follower"
																	/>
																</div>
															</div>
													...
													<div className="followers__item">
														...
														<div className="followers__wrap">
															<div className="followers__gallery">
																<div className="followers__preview">
																	<img
																		src={'img/content/follower-pic-5.jpg'}
																		alt="Follower"
																	/>
																</div>
																<div className="followers__preview">
																	<img
																		src={'img/content/follower-pic-6.jpg'}
																		alt="Follower"
																	/>
																</div>
																<div className="followers__preview">
													...
													<div className="followers__item">
														<div className="followers__user">
															...
															<div className="followers__details">
																...
																<button className="button-small followers__button">
																	Follow
																</button>
															</div>
														</div>
